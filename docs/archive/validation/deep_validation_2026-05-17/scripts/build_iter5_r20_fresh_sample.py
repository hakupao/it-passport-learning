#!/usr/bin/env python3
"""Build iter_5 R20-FRESH 10-page fresh sample for blind verification.
...
Seed = 20260525. Deterministic.

Output: validation/deep_validation_2026-05-17/iter_5/r20_fresh_sample.json
"""
...
OUT = ITER5 / "r20_fresh_sample.json"
...
def main() -> None:
    ...
    assert not overlap, f"R20 sample overlaps prior audited: {sorted(overlap)}"
