...
| **2** | DataSource interface + FsDataSource adapter + index.json v2 backfill | `DataSource.ts` + `FsDataSource.ts` + index.json v2 (chapters[]+glossary_index+entity_by_id per D-089) | `step_02_datasource/` + unit tests (TDD) | 2 day |
