...
| 次セッション | **① 残 8 exam (88 問) を A + note で続行** (S117 で 7 exam 完了: pilot 2 + batch 1 3 + batch 2 3。batch 3 = 2016h28a / 2018h30a / 2019h31h / 2021r03 を S117 内で開始)。手順 S117 log §12 #1 + §14b/§16b の教訓 (note 差し替えはマーカー冪等、page 番号は source.page_number から、挿入型置換は入力層の既在チェック)。D-141 系の前文投入問は保真核験で毎回 DISCREPANT に見える → 識別手段が backlog。 |
