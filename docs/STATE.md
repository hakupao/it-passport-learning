...
| 字段 | 值 |
|---|---|
| 最后更新 | **2026-09-25 Session 125 (続 4、終了) — ⑤-2 U9 2024r06 完了 (Rule D PASS-with-notes)、本 session で U5〜U9 の 5 unit 完了 (全て別 type reviewer PASS-with-notes、MAJOR/MINOR 0、correct_answer 0)**。U9: 72 問、run `wf_35e2fa62-0ea` 4.64M token、machdiff MISSED 0、採用 11 / 5 題 (q012 ア 正解肢 読点 / **q059 ア 19cnm→10cm 斜線ゼロ = U5〜U9 の 5 exam 連続** / q062〔プログラム〕+ 擬似言語リテラル “” [源は ASCII 等幅の 99+99 字形、reviewer 承認] / q082 / q085)。fixer 逸脱 4 件すべて承認。⑨ 新規: 擬似言語リテラル字種規約 / [プログラム] 残存 raw `2025r07-q078` + zh `2023r05-q060` / 行跨ぎ読点後の空白欠落 corpus 310 件 / fidfix 雛形改善 (ヘルパ名衝突・subN 事後確認)。累計 1057 問 / 129 題 / 12.2% / 正解肢上 30 / aa 6。build ✅。evidence `quiz_full52_u9_S125.md`。<br>**(S125 U8)** **2026-09-25 Session 125 (続 3) — ⑤-2 U8 2023r05 完了 (Rule D PASS-with-notes)**: 91 問、run `wf_b22ad070-03c` 5.93M token、採用 20 差分 / 16 題、正解肢上 4 (q035 ア / q093 エ / q099 ウ)、machdiff 実残差 0。**q011 clean「変革」→ 源「刷新」= raw の脱字を clean 層が推測補完していた新型 (⑨ 横断走査)**、q025 19万円→10万円 (斜線ゼロ、U5〜U8 で 4 exam 連続、解説論拠書換)。correct_answer 0。MAJOR 0 / MINOR 0 / NIT 5 全処置 (⑨: fidfix 雛形の無条件 write / pointSub zh・en 欠落で throw しない)。累計 985 問 / 124 題 / 正解肢上 29 / aa 6。evidence `quiz_full52_u8_S125.md`。<br>**(S125 U7)** **2026-09-25 Session 125 (続 2) — ⑤-2 U7 2022r04 完了 (Rule D PASS-with-notes)、本 session で U5〜U7 の 3 unit 完了**。U7: 75 問、run `wf_9220b31c-fa2` 4.94M token、採用 36 差分 / 19 題 (machdiff 実残差 4 = q001「問1」/ q017 イ / q018 ウ・エ)、正解肢上 9、**aa 3 = q032 選択肢が図 (テキスト注記が構造を取り違え、zh/en 正解肢が答えを書いていた) → D-144 段 2 choice_figures 化** (WebP 4 枚、切り出しインク総量一致で欠落 0)、**q066 斜線ゼロ 109/199/190→100** (解説 3 語数値追随・論拠書換)、q073「TIPv*」→「IPv*」、q089 ウ 文字別→文字列 ほか。correct_answer 0。MAJOR 0 / MINOR 0 / NIT 4 全処置。**⑨ 優先 (出荷層): `2019h31h-q001` zh「问1」/ en「Q1」+ `2015h27a-q089` 同型の見出し混入が残存**。⑨ 新規: precrop 頁パリティ (偶数頁見出し x=166〜175 が許容 [136,168] 超過) / zh/en が腐敗文を直訳 (q018 / q066) / choicefig `--only` なしで 2014h26a-q086 throw / sidecar↔.phase1 既存乖離 21 field。累計 894 問 / 108 題 / 12.1% / 正解肢上 25 / aa 6。build ✅。evidence `quiz_full52_u7_S125.md`。<br>**(S125 U6)** **2026-09-25 Session 125 (続) — ⑤-2 U6 2021r03 完了 (Rule D PASS-with-notes)**: 88 問、run `wf_180a2db0-a1b` 5.57M token、採用 16 / 13 題 (agent 14 + machdiff 実残差 2 = q070 読点 / q100「問100」混入)、正解肢上 2 (q010 エ / q024 ア)、semantic q008 clean「及ぼす→与える」/ q011「適している。」復元 / q051「IoT」/ q072「キャリアアグリゲーション」ほか。**q053 UNREADABLE → page 記録ずれ 2 件 (q051 23→24 / q053 24→25) を D-145 pagefix-apply で bank・by_year 是正** (全 100 問ずれ走査で他 0、reviewer が OCR 非依存方式で独立確認)。correct_answer 0。MAJOR 0 / MINOR 0 / NIT 4 全処置。⑨ 新規: precrop 題番号非照合 / page ずれ全 exam 横断走査 / MOVE_QUESTION 恒久ゲート不在 / q050 figure_description 斜線ゼロ誤読 (母集団外)。累計 819 問 / 89 題 / 正解肢上 16 / aa 3。evidence `quiz_full52_u6_S125.md`。<br>**(S125 U5)** **2026-09-25 Session 125 — ⑤-2 U5 2020r02o Sonnet 5 単 pass 完了 (D-146 第 7 unit、Rule D PASS-with-notes)**。母数 **60 問** (PLAN の 73 は誤り、未着手 6 exam の PLAN 記載値も population 実数に訂正: 2021r03 88 / 2022r04 75 / 2023r05 91 / 2024r06 72 / 2025r07 80 / 2026r08 71)。run `wf_4c528418-96c` 60/60、3.88M token / 9.3 分、UNREADABLE 0、part 壊れ 0、DISCREPANT 15 / 差分 24 / 正解肢上 4、machdiff same 293 / MISSED 7 = 偽陽性 7 (q001 表型 / q011 DFD 図文章化) → 実残差 0。是正 15 題 24 差分 127 field (raw 69 / sidecar 15 / .phase1 15 / 解説 16 / note 12): **q004 過去19年→10年 ×2・q075 ア/イ = 斜線入りゼロの 9/6 誤読 (4 exam 目)**、q026 防災品→防炎品 (zh/en 追随)、q023 都門→部門 + ノンブル混入、q049 問繁→頻繁、q078 TIP→IP (解説「表記誤り」注記除去)、**q100 ア 相手方→相手 (正解肢) / イ 読み見→盗み見**、q016 斬新的な (clean 層)、ほか cosmetic。choices_jp_clean 無し = 選択肢腐敗は学習者に見えていた。correct_answer 0 / 2900。fixer executor opus → reviewer `pr-review-toolkit:code-reviewer` opus (別 type): 24/24 独立実読一致、MAJOR 0 / MINOR 0 / NIT 3 (evidence 記述) 全処置。**D-147 §6 残課題 = ユーザー決定「受容して ⑨ に残す」**。⑨ 新規: 数字列の源照合走査 (斜線ゼロ) / q011 正解肢エの括弧書きが答えを示唆 (② track 候補) / generate_result note と expl_jp note の 2 系統不整合 / precrop page_mismatch 3 unit 連続 / q089 同型「.,」母集団外 2 件 / q085 .phase1 en と sidecar の既存 drift。累計 731 問 / 76 題 / 10.4% / 正解肢上 14 / aa 3。evidence `quiz_full52_u5_S125.md`。push 済 (本 session、ユーザー事前承認)。<br>**(S124)** **2026-09-09 Session 124 — D-147 §6 (解説層 丸数字区切り) + ⑤-2 U4 2019r01a Sonnet 5 単 pass 完了 (D-146 第 6 unit、Rule D PASS-with-notes)**。**D-147 §6**: ユーザー gate「23 問の解説を決定的正規化」→ attempt 1 (122 field、note_jp 含む) は reviewer FAIL (散文の節境界読点 4 field 誤置換 + note_jp の zh 引用 1、**教訓: 正規表現の安全性は入力の形 [choices = 裸の列挙] が担保していたもので散文に流用できない**) → Rule B `failures/quiz_marunum_expl_S124_attempt_1.md`、.phase2 を HEAD sidecar から復元 → attempt 2 (run 単位 MIXED/DUP ガードで field 丸ごと SKIP、note_jp 対象外) = **18 問 / 106 field、round1 新規 0、PASS-with-notes** (commit bf96f9e)。残課題 (⑨、**ユーザー判断待ち**): SKIP 4 field により 2010h22a-q097 / 2018h30a-q081 は同一問内の字種不統一が残る (閉じるには LLM 改写 = Rule A)。**U4**: 母数 **52 問** (PLAN の 59 は算術誤り)、run `wf_80761953-9cb` 52/52、3.12M token / 8.8 分、UNREADABLE 0、part 壊れ 0、DISCREPANT 4 / 差分 4 / 正解肢上 1、**machdiff same 260 / MISSED 0 = 実残差 0・偽陽性 0 (初)**。是正 4 題 14 field (raw 12 + final note 2): q016 イ / q036 ウ / q041 ア 読点脱落 (choices は clean 層無し = 学習者に見えていた) / **q097 エ 減失→滅失 (semantic、30 倍直読の位相差で確定、zh/en/解説は元から正)**。correct_answer 0 / 2900。fixer executor opus → reviewer `pr-review-toolkit:code-reviewer` opus (別 type): 4 題自前切り出し独立実読 + CLEAN 3 題、MAJOR 0 / MINOR 4 / NIT 5 (evidence 記述精度) 全処置。⑨ 新規/再確認: machdiff「空虚な一致」(agent 計上済 field は patch を外して評価、優先度上げ) / 読点脱落型の決定的走査 = 未監査 8 field / 6 問 (うち 3 id は ⑤-2 母集団外・excluded → S118 R8b 実読 lane) / **corpus 29 exam 中 13 exam が全量 sweep 対象外** (S118 §223(5) 既登記) / `2023r05-q032.ア` が q016 イ と同文同位置の脱落 (抽出工程起因の疑い) / precrop page_mismatch 2 unit 連続 / q016 解説の肢引用で区切り字種が割れる。累計 671 問 / 61 題 / 9.1% / 正解肢上 10 / aa 3。evidence `quiz_full52_u4_S124.md`。**push 済 (本 session、ユーザー事前承認)**。<br>**(S123)** **2026-09-08 Session 123 — ⑤-2 U3b 2019h31h Sonnet 5 単 pass 完了 (D-146 第 5 unit、Rule D PASS-with-notes) + D-147 lock**。run `wf_f840c3f7-511`: 87/87、5.17M token / 16 分、UNREADABLE 0、part 壊れ 1 (journal 復元)、DISCREPANT 10 / 差分 18 / 正解肢上 1、machdiff MISSED 18 = 偽陽性 17 (表型選択肢 13 / q059 表 cell 句点 4) + **実残差 1 (q001 stem「問1 」混入、agent 見逃し)**。是正 9 題 / 17 差分 / 65 field (raw 30 / sidecar 19 / .phase1 13 / final note 3): **q015 少量→大量 (semantic)** / q037「がな」/ q062 stem「①〜③」復元 + 4 肢区切り / q001 前綴 / q007・q096 引用符 “ ” + 読点 / q053・q096 亀甲括弧 / q034 単位括弧 / q064 読点。非採用 q084「；」= 画素計測で紙面汚点 (fixer + reviewer 独立同意)、q082 図の言語化。**D-147** (丸数字列挙区切り: jp「①, ②」/ zh「①、②」/ en「①, ②」and 形適合、脱落 = 差分・字種差 = 表記揺れ、根拠 = 文化庁 公用文作成の考え方 Ⅰ-5(1) + 出荷層読点多数派) を `quiz-marunum-sep-D147.mjs` で 23 問 294 field 正規化 (choices のみ、題幹波及 0)。correct_answer 0 / 2900。fixer executor opus → reviewer `pr-review-toolkit:code-reviewer` opus (別 type): 9 題原寸独立実読 + CLEAN 2 題 + D-147 全 23 問、MAJOR 0 / MINOR 3 / NIT 3 (記述精度) 全処置。**⑨ 脚本: precrop 較正をページ投票に修正** (2019h31h が 0/87 → 83/87、2018h30h / 2015h27a の crop md5 同一、Rule B `failures/quiz_full52_S123_u3b_precrop_attempt_1.md`)。⑨ 新規: **q062 解説の丸数字引用「①③」と choices「①, ③」の旧新併存 → D-147 拡大に伴い解説本文突合 (U4 前、優先高)** / q053 raw「59本」= 源「50本」(N5 数値型 2 件目) / 表 cell 句点方針 / machdiff 構造的偽陽性 (q034 型) / prompt「問N 」混入検出 / page-37 detected 3/4 未調査。累計 619 問 / 57 題 / 9.2% / 正解肢上 9 / aa 3。evidence `quiz_full52_u3b_S123.md`。**push 済 (本 session、ユーザー事前承認)**。<br>**(S122)** **2026-09-08 Session 122 — ⑤-2 U3a 2018h30h Sonnet 5 単 pass 完了 (D-146 第 4 unit、Rule D PASS-with-notes)**。run `wf_fb2409c7-386`: 70/70、4.25M token / 26 分、UNREADABLE 0、part 壊れ 2 → `merge-parts --journal` 初回本番で復元、DISCREPANT 8 / 差分 13 / 正解肢上 2、machdiff same 345 / 残差 5 = 全て既知型偽陽性 (q005 transcript「[図]」×4 / q043 箇条書き記号) → 実残差 0。是正 8 題 88 field (raw 36 / sidecar 12 / .phase1 7 / final note 3 / D-144 段 2 30): q030 幾度 (semantic) / q001 引用符 “ ” / q035・q062・q063 末尾 junk / q085 丸数字区切り (兄弟問 q072 準拠、源の字形は判別不能) / q096 源に無い読点 / **q005 = 選択肢即図型 (正解肢テキスト「DFD」が設問文と同語で答えを書いていた) → `quiz-choicefig-D144s2.mjs` SPEC 追加で choice_figures 化 (2016h28a-q050 と同型、A6 GREEN)**。correct_answer 0 / 2900。fixer executor opus → reviewer `oh-my-claudecode:code-reviewer` opus (別 type): 8 題原寸独立実読 + CLEAN 2 題、MAJOR 0 / MINOR 2 (evidence 記述) / NIT 3、全処置。⑨ 新規: q085 raw「9個以上」= 源「0個以上」(N5 数値型) / 丸数字区切り字種の全体方針 (U3b `2019h31h-q062` 前に D-NNN) / q001 en 「」残存 / agent source_text 全文化 / bank choices_jp キー順 9 問。evidence `quiz_full52_u3a_S122.md`。**push 済 (本 session、ユーザー事前承認)**。<br>**(S121)** **2026-09-08 Session 121 — ⑤-2 U2 波 1〜3 Rule D 完了 (D-146 第 3 unit) + ⑨ 脚本改修 2 件**。reviewer 3 体 (波 1 `feature-dev:code-reviewer` / 波 2 `oh-my-claudecode:code-reviewer` / 波 3 `pr-review-toolkit:code-reviewer`、いずれも opus、fixer と別 type) を直列で起動、6 exam 462 問 / 是正 41 題 (波 2 evidence は 15→16 訂正) を**全題原寸で独立実読**: **MAJOR 0 / 誤是正 0 / correct_answer 変更 0**、machdiff 4 run×3 波を再実行して evidence の計数を再現、各 reviewer がゲートを自走 (crosscheck / chumon / assert-clean / tsc / vitest 501)。指摘 = evidence の計数・記述誤り MINOR 11 (採用 15→16、去重 6/12→8/11、severity 18→20 field 等) + ⑨ 級 NIT 15、**データ修正を要する指摘 0** → 全件 evidence 訂正で処置。横断所見: raw / `.phase1` の無言 skip (波 1 q043 / 波 2 q094 / 波 3 q079・q090) = 出荷源が clean + sidecar のため影響 0、**再 merge 禁止 (S117) を 3 evidence に再明記**、次波 fixer 雛形の sub() に「to が在る」肯定確認を追加すること。⑨ 脚本: `merge-parts --journal` (journal.jsonl の StructuredOutput を正、S120 run で 68/68 再現、失敗行防御・part 存在検査・引数検査) + fidelity prompt 0b 隔離 (allowlist 3 種、手段を問わず、explanations/・generate_result 禁止) → reviewer-1 復験 6/6 解消。evidence `quiz_full52_ruleD_U2_S121.md`。**push 済 (cae99ad、2026-09-08)**。<br>**(S120)** **2026-09-08 Session 120 — ⑤-2 U1 Sonnet 5 A/B 完了 (D-146 第 2 unit、Rule D PASS-with-notes)**。2015h27a 68 問を波 1 是正前スナップショット + `--precrop` で Sonnet 単 pass (run `wf_ce7c01b8-868`、4.03M token / 15 分): **差分召回 12/12・問召回 8/8・偽陽性 0・machdiff 残差 1 (q066 既知仕様)** = Opus 最良単 pass (gp) と同等 (本 exam で Opus cr の寄与 0)。画像 Read 2.3 回/問 (precrop 実効、1 回 = 43 問)。**判定 PASS → 以後の抄写 agent は Sonnet 5 単 pass 既定 (machdiff 必須のまま)**。U0 実証: part 書き出し 66/68 (q034/q066 壊れ JSON → journal.jsonl の StructuredOutput から復元、`.broken` 保存)、part ≠ StructuredOutput 31/68 (notes のみ、鍵 field 全一致) → journal を正とする。隔離欠陥: q066 が S118 Opus 監査を事前参照、7 agent が別題 part を Read → ⑨ prompt に evidence/・fidparts/ 参照禁止 + merge-parts `--journal`。PLAN §2 基準訂正 (「13 題」→ 8 問 / 12 差分)。データ変更 0、crosscheck A1–A7 B1–B7 GREEN。evidence `quiz_sonnet_ab_S120.md`。**push 済 (0419647、2026-09-08)**。<br>**(S119)** **2026-09-08 Session 119 — ⑤-2 U0 脚本改修 完了 (D-146 第 1 unit、Rule D PASS 3 往復)**。Workflow 脚本に fs が無いため、核験 agent が audit を part file (絶対パス) へ Write → 新脚本 `quiz-fidelity-merge-parts.mjs` (0 token) で従来同形の全文 JSON に束ね、workflow の return は計数 + 40 字要約のみ (`audits` 無し、70170→2886 字)。`model` は args で切替。`quiz-fidelity-prep-any.mjs --precrop`: 問N 見出し行帯検出 (sharp) で題目領域を前裁断、**chumon member ∪ 内容判据 (displayed > stem_jp×1.6+40) の 164 題は crop 除外** (reviewer が q097 / q085 で「前文が帯外 → 正しい前文を fixer が削除する経路」を実証したため)、2015h27a 90/100 cropped、`prev_page_png` を manifest に付与、prompt に回退第 4 条 (crop 外の前文は源 + 直前ページを読む) + 注記禁止 + 区切り記号/引用符/挿入の計上 + discrepancies≥1 なら DISCREPANT。machdiff に `VERDICT_CONFLICT`。回帰把関: 2015h27a_gp 338/2、2017h29h_cr 422/3 改修前後同一。crosscheck A1–A7 B1–B7 GREEN、data/ apps/ 変化 0。**U1 初回 run で part 書き出し成功率と crop 優先読みの実効性を要実証**。commit のみ、push はユーザー gate。<br>**(S118)** **2026-09-07 Session 118 — 横断 backlog 第二歩 完了: A7 / ⑨ 遺留 3 件 / page-12 / D-143 §7 / ⑤-3 抽検 + ⑤-4 検出器 / ⑦ = D-145 lock + 50 題適用**。**⑤-3** (seed 118、4 exam × 20 問、gp/cr 双 pass 8 run + machdiff): **14/80 = 17.5%** (agent 12 + machdiff 2)、正解肢上 5、**answer_affecting 1 (`2018h30a-q096` エ 否定反転 = 二重正解)** → 124 フィールド三層 + zh/en + 解説 2 問全文書き換えで是正 (Rule D PASS、9 題原寸独立確認)。**事前規則が発火 → ユーザー判断: ⑤-2 全量を分批で実行 (S118 §31)。実施: R8 決定的削除 185 箇所 (commit 734697d) → 母数 1208 / 8 波 → 波 1〜3 (2015h27a / 2016h28a / 2016h28h / 2017h29a / 2017h29h / 2018h30a) の核験 + 是正完了 [波 1 13/152 = 8.6%、波 2 15/158 = 9.5%、波 3 fixer 完了待ち; Rule D 未審]、波 4 (2018h30h / 2019h31h) は途中停止 (§42、resume 可)、波 5〜8 未着手。**同日 5h 制限に 3 回到達 → D-146 lock (分批・予算・境界)**。**⑤-4** `quiz-choice-defect-scan.mjs` (校正済: 語義置換は原理上不可視・感度 17%、R3/R8a/R8c FP 0、R8b は検索式 FP 10%): R8 以外 36 問 / 50 field + R8b 40 件が実読対象、R8a/R8c 195 件は決定的削除可。**⑦ = D-145** `source.figure_page_image/_number` (欠落 = 同ページ、質量移行なし): 実読 21+14 件 → SPLIT 15 / KEEP 20 / MOVE 0 (S115 型は他 27 回に無し)、共有図 member 35 件を groups.json から決定的導出、**計 50/2900 題**、bbox BAD 11 再裁断 (reviewer 目視 11/11、HIGH 1 是正)、図側 consumer 11 + 書き側 4 を保存式に、B6 拡張 + **B7** + `derive-groups --assert-clean` (50/50 常設)。7/7 md5 再裁断等価で「指針 = 裁図の真の出処」を機械証明。ゲート tsc 0 / eslint 0 err / vitest 501 / build 0 / crosscheck A1–A7 B1–B7。**push 済 (17c0213、2026-09-08)**。<br>**(S118 前半)** A7 名簿 35/137 + crosscheck A7 / ⑨ useGrouping・QuizList・e2e / page-12 再生成 + q028 raw 再抽出 / D-143 §7 `*`/`†`/`!`。運用 = 主 context は調度のみ、4 writer lane + 3 reviewer (別 subagent_type) 並走。**A7**: committed 名簿 `data/ip/quiz/chumon_groups.json` (35 組 / 137 問、生成器 `quiz-chumon-groups-build.mjs --check` を vitest に接続) + crosscheck A7「同組全員が三語で前文 probe を含む」(床 35/137、exceptions は reason 必須)。Rule D が名簿漏登 4 問 (S114 evidence は源問を含めない) と `2013h25a-q099` jp/zh の孤立設問句 (section 型 probe の錨誤り、段 3 遺留) を捕捉 → 是正 (q086 zh 読点 1 字も)。**⑨**: useGrouping 死コード 49 行 / `QuizList` 名前空間 / e2e quiz.spec 書き直し (本地 3/3 + 反向核験)。**page-12**: 源 PDF から再レンダ (1432×2026) + **q028 raw stem_jp が坏図由来の 53 字残骸だったのを 163 字に再抽出** (表示層 clean は元々完全 = 学習者影響なし)。**D-143 §7**: 名簿マーカー `*`/`†`/`!`。ゲート tsc 0 / eslint 0 err / **vitest 501** / build 0 / crosscheck A1–A7 B1–B6 GREEN。**commit のみ、push はユーザー gate**。S118 log 全 14 節。<br>**(S117)** 横断 backlog 第一步 (④⑥⑧③) 完了。启動詞「backlog 第一步」。**④** 既存 18 exam の sidecar 再 merge (11 変化・user-facing テキスト変化 0・key_guard final publish 18 問 + round1 併記、独立 reviewer が merge 複製で 29/29 byte 同一を確認)。**⑥** `scripts/quiz-keys-crosscheck.mjs` 新設 (A1〜A5 committed 層 = vitest 常時 / B1〜B4 raw 層 = ローカル gate) — **初回実行で by_year の stale key 3 件を捕捉** (2011h23a-q100 / 2014h26h-q100 / 2015h27h-q100、承認済み値へ同期)。reviewer 変異試験で B4 の穴 2 件 → 双方向化。**⑧ D-143 lock**: explfix は generate_result の final だけを全文書き換え、round1 不可触、suspect=union 不変。**③ D-142 lock**: ホスティング → 主机租用（hosting） / ハウジング → 机房托管（housing/colocation）、禁止語 主机托管・服务器托管。96 フィールド / 11 ID (出荷層 37 + merge 入力層 59)、Rule D 65 件全件 PASS、evidence `quiz_zhterm_hosting_D142_S117.md`。**① の母数を再実測: 462/27 ではなく 241 問 / 16 exam** (S110〜S116 の 13 exam 分が既に双 pass 済)。pilot 方案 (C 案: 2019r01a + 2024r06 で A/B 併走) を S117 log §5 に記載、**ユーザー gate 待ち**。tsc 0err / eslint 0err / **vitest 464** / build exit 0 / crosscheck full GREEN。questions.json 2900・correct_answer 変更 0。**commit のみ、push 未実施 (ユーザー gate)**。 **【S117 続き・2026-09-07】ユーザー gate で push (a67db88) + ① pilot 実行**: 2019r01a + 2024r06 で A (s7x 双 pass 33 問) / B-note (5 問) / B-sample (無作為 40 問) を 10 workflow で併走。**A の DISCREPANT 率 32% / 25%、正解肢上 1 (q040 ウ 滞進的→漸進的、A 射程内)、B∖A の正解肢上 0 → 事前規則どおり残 14 exam は A + note 起点掃引で行く**。B-sample の基礎率 7.5% (誤答肢の軽微欠陥) は ⑨ に登録。24 差分を 129 フィールド (JP 3 層 + zh/en 11 + 解説 2 件全文書き換え + final note 7 問 [D-143 初適用]) で是正、Rule D PASS-with-notes → 波及漏れ 4 件も是正。同族 OCR クラス「ーつ」を corpus 横断で 60 箇所是正。**教訓: translations sidecar は phase1 再 merge 禁止 (入力層 stale、再 merge で 96 フィールド退行→戻した)**。新設 `quiz-fidelity-prep-any.mjs`。crosscheck full GREEN / vitest 464。 **【S117 batch 1・2026-09-07】2022r04 / 2020r02o / 2016h28h を A + note で処理**: A 側 DISCREPANT 20% / 18% / 29%、2016h28h の note 起点 13 問は 13/13 実欠陥 (正解肢上 3 = S108 の choice-OCR backlog が出荷されていたもの)。43 差分 → 191 フィールド是正 (解説 2 件全文書き換え、note 13 問 D-143)、Rule D PASS-with-notes → B1 (note 誤分割) + N1〜N3 是正。「適切なか」型を横断 1 件。crosscheck GREEN / vitest 464。**残 11 exam (2015h27a 14 / 2016h28a 13 / 2017h29a 8 / 2017h29h 10 / 2018h30a 13 / 2018h30h 21 / 2019h31h 12 / 2021r03 12 / 2023r05 9 / 2025r07 17 / 2026r08 11 = 140 問)**。 **【S117 batch 2】2018h30h / 2025r07 / 2015h27a 完了**: **answer_affecting 級 2 問を初捕捉 (2018h30h-q039 SLA 閾値 20→30 分 + 選択肢時刻 / q064 srv01→srv91 + 正解肢 ipa.9o.jp)、いずれも note 起点側**。2015h27a-q086 は図テキスト化表の列字母ずれ (新クラス)。37 差分 → 223 フィールド + Rule D 追随 11。残 8 exam (2016h28a 13 / 2017h29a 8 / 2017h29h 10 / 2018h30a 13 / 2019h31h 12 / 2021r03 12 / 2023r05 9 / 2026r08 11 = 88 問)。 **【S117 batch 3+4・2026-09-07】① 完了 (16/16 exam)**: batch 3 (2016h28a / 2018h30a / 2019h31h / 2021r03、A 50 + note 7) → DISCREPANT 12 問・正解肢上 4・answer_aff 0、147 フィールド是正 (2018h30a-q002 リピート→リベート zh/en/解説追随、2021r03-q095 商品C 復元、同形字 力→カ 初出、横断 2020r02o-q035)。batch 4 (2017h29a / 2017h29h / 2023r05 / 2026r08、A 38 + note 6) → DISCREPANT 7 問・正解肢上 2・answer_aff 0、97 フィールド (2017h29a は差分 0)。**初回 attempt は session limit (resets 12pm JST) で審閲 agent + 10 workflow 全滅 → 同入力で再放 (§19)**。Rule D 両 batch PASS-with-followups: batch3 MAJOR = 2021r03-q095 final `stem_corruption_suspected` 未更新 + note 矛盾文 (D-143 §3 違反) → BOOL/NOTE_PRUNE を雛形に追加して是正; batch4 MINOR 4 + NIT 3 全処置 (§18b/§20)。**① 総括 (§21)**: 16 exam 双 pass 完了、answer_affecting は 2018h30h の 2 件のみ。漏検 2 例 (agent が源を正しく書き起こしながら差分未計上: 2017h29h-q027「などは」/ 2026r08-q085「整数値」) → ⑨ 最優先「源書き起こし構造化 + 主 context 機械 diff」。流程欠陥: 共有 scratchpad の汎用ファイル名衝突で別問画像を読む事象 9 件 (全て agent 自己検知) → workflow prompt に一意ディレクトリ強制を要登録。N5 追加 6 題 (raw stem_jp のみ、表示無影響)。crosscheck GREEN / vitest 464 / tsc 0。 |
| 当前阶段 | **Phase 5 Stage 6 / サブ段階「Quiz 接過去問」。【現況 S116】Phase 2 (D-137) = ✅ 全 29/29 完了。2900 問すべてに三語解説が載った。Rule C の `RETROSPECTIVE_phase2.md` も同 session で執筆済。**<br>**【現況 S117】横断 backlog 第一步 = ✅ ④⑥⑧③ 完了** (D-142 / D-143 lock、crosscheck gate 常設、by_year 同期)。**残 backlog** (優先度順): ~~① s7x 未核験 241 問 / 16 exam~~ → **✅ S117 で 16/16 exam 完了** (pilot + batch 1〜4、answer_affecting 2 件是正、S117 log §21) ② 図/シナリオ再抽出 track (選択肢が図そのもので、テキスト化した時点で出題構造が壊れる型。5 exam 分蓄積) ~~③ hosting/housing zh (S117 D-142 完了)~~ ~~④ 18 exam 再 merge (S117 完了)~~ ⑤ semantic choice-OCR cleanup track (16 exam; **S118: ⑤-3 抽検 17.5% / 正解肢 5 / answer_aff 1 → 是正済、⑤-4 検出器常設。事前規則により ⑤-2 全量 (≈1600 問双 pass) の可否 = ユーザー判断待ち**; 代替 = ⑤-4 命中 76 件の実読 + R8a/R8c 決定的削除のみ) ~~⑥ 交叉核対 CI 化 (S117 完了、`quiz-keys-crosscheck.mjs` + vitest)~~ ~~⑦ `source.page_image` のスキーマ問題 / 中問先頭問のページずれ候補 19 件~~ → **✅ S118 D-145** (`figure_page_*`、50 題適用、bbox 11 是正、B7 + assert-clean 常設)。残: 多図参照 3 題 (D-145 §8a) / `figure_source_corrected` 3 題の実読 / 中問 2 問目以降の単独跨ページ型は未掃引 ~~⑧ explfix note 方針 (S117 D-143 lock)~~ ⑨ cosmetic 横断 (分野見出し 42 問 / ASCII 引用符 139 問 / zh 本土 polish / 図クロップの端切れ / **S117 追加**: 保真核験 workflow の源書き起こし構造化 + 主 context 機械 diff [漏検 2 例]、切り出し画像の一意ディレクトリ強制、同形字 力↔カ・一↔ー 決定的走査、末尾ノイズ「ーー/-/MN/./ぜい/こう」走査 [clean/choices 層のみ]、B-sample 基礎率 7.5% の誤答肢軽微欠陥、引用符開閉対の欠落を「体裁差」に含めない判定基準文言、**源 PNG と public WebP の鮮度検査** [S111 の q091 差し替えが WebP 未再生成で 4 週間 stale])。~~N5 raw stem_jp 残穴 6 題~~ → **✅ S117 §22c で 3 層とも clean に同期**。~~**資産 backlog**: 2018h30a page-12 源画像が 1432×1340 に切り詰め (再生成対象)~~ → **✅ S118 再生成 + q028 raw stem_jp 再抽出** (failures/assets/ に旧画像)。~~**D-143 §6 retrofit**: suspects 名簿で「round1 由来・final 是正済」を見分ける表示 (2023r05-q056 が q056* で残る)~~ → **✅ S118 (ADR §7、`*` final / `†` round1 のみ / `!` answer_affecting、`q056†!`)**。**A7 ✅ S118** (中問名簿 35/137 + crosscheck A7)。**⑨ S118 追加**: messages `Book` 名前空間孤児 / 共有図組の図側到達率不変式 (mqB・mqC の has_figure=false member 6) / q028 raw 来歴フィールド無し / useGrouping・QuizList・e2e は ✅ S118。~~⑥ 続き~~ → **✅ S117 §22a: crosscheck B5 (stem/choices 3 層一致 + by_year 行欠落検出) 常設、by_year の旧 OCR 残存 284 問 / 451 フィールドを同期** (`quiz-byyear-text-sync-S117.mjs`)。**⑨ の核験 workflow 対策も ✅ §22b** (`source_transcript` + 一意ディレクトリ + `quiz-fidelity-machdiff.mjs`、既知盲点 = 空白の有無)。**新規発見 (S117 §22 末)**: **題幹の markdown 表 190 問 / 選択肢の [表] 83 問が App では生の縦線テキストで表示されている** (当時: QuizSet.tsx が stem/choices に Markdown を通していなかった → 段 1 で解消。「3 shell は図も描かない」は §29 で誤りと判明 [到達不能な dead code、削除]) → ② の設計に合流、ユーザー判断待ち (S117 log §23 の 4 問)。**D-141 前文投入問**は保真核験で毎回 DISCREPANT に見える → 識別 flag。<br>**Phase 5 Stage 6 (Web App 数据統合) 進行中。サブ段階「Quiz 接過去問」。【現況 S101】OCR-garble 一括清理 (D-140 scale 方針) = ✅ 完了** (58 choices drift-proof 是正・FP 15 除外・ブラインド独立再導出 58/58 一致・q096 ISO/OSI 主context 誤りを独立検証が捕捉→訂正・correct_answer 不変・検証GREEN・detector 再scan=FPのみ)。次=Phase 2 scale (28回 续批) + push (ユーザーゲート)。<br>**【S100】**Phase 2 (D-137) re-pilot 2025r07 = ✅ 完了** (解説100/100・Rule A 独立 24/24 accurate 0med/high・bad key 0・cosmetic 腐敗10問15フィールド是正・検証GREEN)。次=ユーザー gate で 29回 scale (+cosmetic OCR scale 検出方法)。<br>**Phase 1.6 (D-139) = ✅ 完了**。D-139-A 確定 bad key 3 件是正済 (`2015h27h-q100` エ→ア / `2009h21a-q091` ウ→イ / `2011h23a-q100` イ→ウ、S98)。**D-139-B 全量 key 盲推審計 = ✅ 図題 467/467 完了** (S99、路由词「Phase 1.6 全量」): bad-key 候補 5 → 写審分離 3 層裁決 (deriver≠critic×3≠主 context 高倍率) → **確定 bad key 2 件是正済 (ユーザー承認)**: `2009h21a-q012` ア→ウ / `2010h22a-q091` ア→エ (questions.json correct_answer 2 件のみ、stem/choices/quiz_index/translations 不変)。deriver 偽陽性 3 件 (q090[=事前疑い1]/q091-2012/q096) は key 正で是正回避。**choices-fidelity track も同 session 完了** (ユーザー「phase2 前に全部做完」): choices 腐敗 28 件を写審分離 (proposer→critic verify→主 context) で **jp 74 letter + zh/en 43 letter 三語是正** (drift-proof、key invariant)。underivable 3 → q087 解答可、**q094/q100-2015h27a は incomplete-source (Phase 2 / 源再OCR backlog)**。**検証 GREEN** (tsc/eslint0err/**vitest463**/build/nft IPA0/構造三語非空)。**Phase 1.6 完全完了 (key+choices 三語クリーン)。次 = Phase 2 (D-137、解析預生成) を figure-fidelity hardening + 全問 key-guard 込みで再 pilot → scale** (ユーザー次 session 予定。ユーザー次 session 予定)。<br>**Phase 2 前 backlog 收尾 (ユーザー「这几个都做了吧」、S99)**: ① **incomplete-source 2 件 = ✅ 修正済** (中問文脈注入、写審分離 author→critic、q094=形式1定義[中問B page-38]/q100=HDD容量8G・40G[中問D page-45]、両者答イ、**critic が author の注記逆転捏造+源に無い1G=1000M追加を捕捉→主 context が原典実読で訂正**、検証GREEN)。② explanations/ = 陳腐草稿 (Phase 2 再生成につき不提交)。③ **figure-display = ✅ 修正完了** (全467 vision sweep `wf_8c5e6dfc-cf2`で 27 crop 候補 → 写審分離 critic 検証+bbox `wf_06800a73-d2f` [偽陽性2除去] → drift-proof 再裁剪/copy/remove `quiz-figfix-apply` → 再検証 `wf_0af86bd2-4b9`+round2 `wf_354f2f56-8ef` で **figure 25 差し替え (q090 cross-page page-38・q099 ← q097 共有 図1 含む) + has_figure=false 3 (q061/q095/q097-2013h25a)**。主 context 実読確認、検証 GREEN [tsc/eslint0err/vitest463/build/nft IPA0]、with_fig 467→464、webp 25 modified+3 deleted)。証拠 `figcrop_audit_S99.md`)。** <br>**(履歴)** Phase 0 = 完了+commit 済 (`0167626`)。Phase 1 (翻訳 backfill) = **完了 (翻訳済 29/29 回、S87 pilot + S88〜S96)**。各バッチ Rule A 独立抽検 (S92 40/40・S93 38/39・S94 39/43・S95 35/37・**S96 50/52** [q092 figure 注記/q077 en gloss/**q002 REGRESSION→REVERT+corpus fix**、全 figure-faithful・独立 critic ACCEPT])・Rule D 写審分離・全検証 GREEN。**Phase 2 前ゲート (図題答案KEY 体検、Session 97) = 完了**: 母集団 247 (choices_resourced_s7x OR figure_repaired)、分層 N=40 vision 審計 (写審分離+毒入校正)、**strict 坏键率 0/40** (BAD_KEY 0、Wilson 95% 上限≤~22)、器具校正 OK (毒 q013 命中=感度・q002/q052 clean=特異度、q052 は審計偽陽性を主context 5×実読で CLEAN 裁決)、非キー選択肢汚染は別件 (~5%、q096/q078/q077)。→ **keys clean → Phase 2 GO**。**Phase 2 (解析預生成) = 着手 (Session 97、ユーザー路由「a」)**: D-019 問答→**D-137 lock** (標準 schema 正解理由+各誤答+要点 / JP先生成→翻訳 / key-guard 内蔵 suspect-flag+照常生成+バッチ末汇总 / pilot-first)。パイプライン scripts×5 + データ層/UI/i18n/test 実装済 (quizExplanation.test 8/8、tsc/eslint clean)。**pilot 2025r07 (100問) 生成 WF `wf_89b6ad0d-52e` バックグラウンド実行中** → 完了後 merge/ruleA/検証/triage → pilot 報告 + ユーザー gate (全 29 回 scale)。 D-136(pilot-first / 翻訳サイドカー `data/ip/quiz/translations/` + reader merge / figure 問 vision 三語クリーン / 教科書 term 束縛) + D-小6 (figure crop+フルページ併読) + D-小7 (repair 語義ガード) + D-小8 (統合バッチ combiner `scripts/quiz-phase1-batch.mjs`、いずれも組込済)。**要ユーザー判断 backlog (上流データ品質、翻訳成果物に影響なし、累積)**: **S94** ~~q052/q092/q096 choices_jp~~ → **同 session で corpus 是正済 (RESOLVED_IN_CORPUS、独立 Rule D 再検証 PASS)**、残 `2012h24h-q018` glossary 職能別組織。(S93 の `2014h26a-q093`/`2014h26h-q088` choices_jp は同 session で corpus 是正済=RESOLVED) `2016h28h-q001`/`q012`/`q096` choices_jp・stem 再OCR + `2015h27a-q088` 図3 基準値 (Stage 2) / `2016h28a-q025` glossary 職能別組織 (textbook) / `2017h29h-q069` choices_jp 再OCR / `2019h31h-q061` figure crop ズレ (図管線 scope)。<br>**(S86 Phase 0)** **Phase 5 Stage 6 (Web App 数据統合) 進行中。サブ段階「Quiz 接過去問」Phase 0 = 実装+Rule D 完了 (Session 86、D-019)、commit 確認ゲート待ち。** — D-134(配信=クリーン派生 `data/ip/quiz/` を un-gitignore、raw bank/pages/figures は gitignored 維持、IPA 条款で公開 OK・出典/改変明記義務)+ D-135(v1=JP-first 2 モード真題面[syllabus 主題別+試験年度別]、翻訳/解析は預生成 backfill Phase 1/2)。**Phase 0 完了**: 首页 500(死語料 `_fixtures/v1.0.3` S63 削除)治癒、quiz 接過去問 v1 上線(2900 問・63 主題・29 回・467 figure、JP-first・出典・reveal)。検証全 GREEN(vitest 446/build/nft IPA=0)+Rule D APPROVE。残段階: 1(翻訳 2900×{zh,en})/2(解析 2900× 三語預生成)/3(教科書統合)。glossary/tutor/chat は死語料依存のまま 500、各自後続サブ段階で移行(band-aid せず)。<br>**(S85 完了)** v1 教科書リーダー(244 unit 上線、目録+per-locale+SVG inline+pager+教科書 NavTab、全検証 GREEN+Rule D APPROVE+nft IPA leak 修正、D-133)。Stage 4 完了(244/244 三語)・Stage 5 は S63 先行済。OQ-03 closed。 |
| 锁定决策 | **147** (D-001 ~ D-147)。**D-147** = 丸数字列挙の区切り字種: jp 三層 ASCII「①, ②」統一 / 脱落 = cosmetic 差分・字種差 = 表記揺れ / zh「①、②」/ en「①, ②」(and 形は適合) / 23 問を決定的脚本で適用 (S123、根拠 = 文化庁「公用文作成の考え方」Ⅰ-5(1) の「混在させない」+ 出荷層読点多数派、`docs/decisions/D-147-marunum-separator.md`)。**D-146** = subagent 並列実行の計画・境界・予算 (1 session = 1 unit、起動前申告、直列、摘要のみ受信、S118、`D-146-bounded-batch-execution.md`)。**D-145** = `source.figure_page_image/_number` (図の別ページ指針、50 題、S118、`D-145-figure-page-pointer.md`)。**D-144** = ② 図/シナリオ track の 4 段方針 (表示層先行 → choice_figures で選択肢即図 → 中問共有資料は軽量組先行・共有図は挂図優先 → 3 shell 統一、S117、`docs/decisions/D-144-figure-scenario-track.md`)。**D-143** = explfix は generate_result の final だけを書き換え round1 不可触 (S117)。**D-142** = ホスティング=主机租用 / ハウジング=机房托管 (S117)。**D-141** = 中問共有前文はグループの全設問に埋め込んで自完結にする (ユーザー gate、S114。アプリに中問グループ表示機構が無く設問は必ず単独表示されるため。起草≠核験の 2 段 workflow + 決定的 apply、`docs/decisions/D-141-chumon-shared-preamble.md`)。**D-140** = Quiz Phase 2 stem-corruption handling (key-guard suspect → 主context 源実読裁決 → stem腐敗は drift-proof 内联修・真坏键は升级 / cosmetic 腐敗も全部内联修 [ユーザー gate ×2、S100] / 硬化=STEM-CORRUPTION GUARD+round-1 key_guard 永続化[repair masking 不可]+stem_corruption_suspected flag+generate_result 永続化手順)。**D-139** = Quiz Phase 1.6 (答案键+選択肢 完整性審計 & bad key 是正): A=確定 bad key 3 件是正済 (`2015h27h-q100` エ→ア / `2009h21a-q091` ウ→イ / `2011h23a-q100` イ→ウ、drift-proof raw bank→rebuild、questions.json correct_answer 3 件のみ変更) / B=全量 key+choices 盲推審計 (図題467 full sweep、写審分離) / C=完了後 Phase 2 (D-137) 全問 key-guard 込み再 pilot。**D-138** = Quiz Phase 1.5 (stem 源再構成) = Phase 2 scale 前の必須前段 (図題467 全数 figure 再構成 / 非fig marked 71 backup 照合 / 出力=翻訳サイドカー更新・reader 不変 / 三語整合 / pilot-first・writer≠figure↔stem checker)。**D-137** = Quiz Phase 2 (解析預生成、標準 schema / JP先生成→翻訳 / key-guard suspect-flag / pilot-first)。 |
...
| 次セッション | **`docs/phase5/PLAN_52_units.md` §0 を読んでから開始。U9 完了 → 次は U10 = 2025r07 80 問 Sonnet 5 単 pass** (qnums は `full52_population_S118.json` の `exams[].qnums` を実数で [zsh では `${pair%%:*}` 等で分割、`set -- $e` は分割しない]; `quiz-fidelity-prep-any.mjs 2025r07 u10 <qnums> --precrop` → workflow `model:sonnet` → `merge-parts --journal` → machdiff (MISSED に実残差が混じる — U6・U7 計 6 件) → fixer opus [雛形 `quiz-fidfix-S125-u9.mjs`、既定 dry-run・`--apply`; U9 NIT-2/3 を反映] → reviewer opus 別 type → gate + build → commit + push)。**`2025r07-q078` raw の「[プログラム]」残存を U10 fixer に名指し**。予算 ≈ Sonnet 520 万 + opus 各 ≤ 300 万、≈ 1 h。その後 U11 2026r08 71 問 → U12 収尾。**起動前に D-146 第 2 条の申告 → ユーザー承認**。ユーザー判断待ち: なし。⑨ 優先: (1) **出荷層の見出し混入 `2019h31h-q001` zh/en + `2015h27a-q089`** (2) **数字列 (斜線ゼロ) の源照合走査 — U5〜U9 の 5 exam 連続** (3) clean 層の推測補完 (U8 q011 型) 横断走査 (4) precrop 頁パリティ + 題番号照合 (5) page 1 頁ずれ全 exam 走査 + MOVE_QUESTION 恒久ゲート (6) machdiff 空虚な一致 (7) 読点脱落 / 行跨ぎ読点後空白 310 件 (8) 擬似言語リテラル字種規約。S125 は push 済。 |
