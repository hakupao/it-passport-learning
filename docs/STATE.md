...
| 次セッション | **① 残 14 exam を A (s7x 双 pass) + note 起点掃引で処理する** (pilot 判定、S117 log §10/§12)。対象 208 問 (2015h27a 14 / 2016h28a 13 / 2016h28h 21 / 2017h29a 8 / 2017h29h 10 / 2018h30a 13 / 2018h30h 21 / 2019h31h 12 / 2020r02o 22 / 2021r03 12 / 2022r04 25 / 2023r05 9 / 2025r07 17 / 2026r08 11)、1 session 2〜3 exam。手順は S117 log §12 #1 (prep-any → 双 pass → note 掃引 → fidfix 多層 → phase2 再 merge → crosscheck full → Rule D)。**translations は再 merge 禁止 (sidecar + .phase1 入力層に同じ置換)、explanations は .phase2 入力層を直して再 merge** (D-143)。commit/push gate は session 冒頭で確認。 |
