...
// ===== GENERATED (choices-fidelity proposer) — embedded items =====
const inputPath = "/Users/bojiangzhang/MyProject/IT-Passport-Learning/data/ip/quiz/.keyaudit/input_choicesfix.json"
const items = [{"id":"2009h21a-q036"},{"id":"2010h22a-q061"},{"id":"2010h22a-q064"},{"id":"2010h22a-q066"},{"id":"2010h22a-q097"},{"id":"2010h22h-q005"},{"id":"2010h22h-q077"},{"id":"2010h22h-q079"},{"id":"2011h23a-q089"},{"id":"2011h23tokubetsu-q070"},{"id":"2011h23tokubetsu-q099"},{"id":"2012h24a-q023"},{"id":"2012h24h-q100"},{"id":"2013h25h-q068"},{"id":"2014h26h-q087"},{"id":"2014h26h-q090"},{"id":"2016h28h-q001"},{"id":"2016h28h-q012"},{"id":"2016h28h-q080"},{"id":"2016h28h-q096"},{"id":"2017h29a-q092"},{"id":"2017h29h-q069"},{"id":"2018h30h-q081"},{"id":"2019r01a-q099"},{"id":"2020r02o-q011"},{"id":"2024r06-q057"},{"id":"2024r06-q081"},{"id":"2025r07-q078"},{"id":"2010h22a-q094"},{"id":"2012h24h-q087"},{"id":"2015h27a-q100"}]
...
log(`提案完了 ${clean.length}/${items.length}: needs_fix ${needFix.length} | 偽陽性 ${falsePos.length} | answer-affecting ${ansAff.length}`)
