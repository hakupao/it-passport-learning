export const meta = {
  name: 'quiz-phase2-trsweep',
  description: 'JP↔訳文の項目単位照合 (全問 sweep、S111 常設化): 失格したものだけを再訳→独立核験する。exam_id は args で指定',
  phases: [
...
const E = parsed?.exam_id
const QNUMS = parsed?.qnums
if (!E || !Array.isArray(QNUMS) || !QNUMS.length) throw new Error('need {exam_id, qnums:[...]}')
