...
// ===== GENERATED (D-139-B REM batch) — embedded items, sandbox has no FS =====
const inputPath = "/Users/bojiangzhang/MyProject/IT-Passport-Learning/data/ip/quiz/.keyaudit/input_batch_REM.json"
const items = [{"id":"2022r04-q096"},{"id":"2022r04-q097"},{"id":"2023r05-q008"},{"id":"2023r05-q013"},{"id":"2023r05-q033"},{"id":"2023r05-q037"},{"id":"2023r05-q041"},{"id":"2023r05-q042"},{"id":"2023r05-q047"},{"id":"2023r05-q048"},{"id":"2023r05-q059"},{"id":"2023r05-q063"},{"id":"2023r05-q075"},{"id":"2023r05-q076"},{"id":"2023r05-q077"},{"id":"2023r05-q086"},{"id":"2025r07-q026"},{"id":"2025r07-q030"},{"id":"2025r07-q037"},{"id":"2025r07-q039"},{"id":"2025r07-q045"},{"id":"2025r07-q054"},{"id":"2025r07-q062"},{"id":"2025r07-q066"},{"id":"2025r07-q069"},{"id":"2025r07-q071"},{"id":"2025r07-q072"},{"id":"2025r07-q073"},{"id":"2025r07-q076"},{"id":"2025r07-q078"},{"id":"2025r07-q083"},{"id":"2025r07-q099"},{"id":"2026r08-q003"},{"id":"2026r08-q026"},{"id":"2026r08-q044"},{"id":"2026r08-q050"},{"id":"2026r08-q055"},{"id":"2026r08-q057"},{"id":"2026r08-q068"},{"id":"2026r08-q069"},{"id":"2026r08-q072"},{"id":"2026r08-q074"},{"id":"2026r08-q076"},{"id":"2026r08-q085"},{"id":"2026r08-q099"}]
if (!items.length) throw new Error("no items embedded")
...
const und = clean.filter((r) => !r.derivable).map((r) => r.id)
const choicesBad = clean.filter((r) => r.choices_faithful === false).map((r) => r.id)
log(`盲推完了 ${clean.length}/${items.length}: confidence ${JSON.stringify(byConf)} | underivable ${und.length} | choices-issue ${choicesBad.length}`)
return { total: items.length, done: clean.length, byConfidence: byConf, underivable: und, choices_issues: choicesBad, results: clean }
