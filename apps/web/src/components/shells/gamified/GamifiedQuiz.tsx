      ...
      {summaries.length === 0 ? (
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {summaries.map((s) => (
            <li
              key={s.questionId}
              className="border border-white/[.08] rounded-xl p-4 bg-white/[.03] flex flex-col gap-2 hover:border-[#e94560]/50 transition-colors"
            >
              ...
              <p className="text-sm leading-snug text-white/85" lang="ja">
                {s.stemJp}
              </p>
              ...
              <button
                ...
                className="mt-1 self-start text-xs rounded-lg bg-[#e94560] text-white px-3 py-1.5 hover:opacity-90 transition-opacity focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e94560] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0f0f1a]"
              >
                {tCommon("explain")}
              </button>
            </li>
