...
export function ChapterQuizPicker({
  ...
  return (
    <>
      ...
      >
        <div
          className="w-full sm:max-w-2xl bg-white dark:bg-black border border-black/10 dark:border-white/[.14] rounded-t-2xl sm:rounded-2xl shadow-2xl flex flex-col max-h-[85vh]"
