...
export function TermPopover({
  ...
  return (
    ...
    >
      <div
        className="w-full sm:max-w-lg bg-white dark:bg-black text-black dark:text-white border border-black/10 dark:border-white/[.14] rounded-t-2xl sm:rounded-2xl shadow-2xl flex flex-col max-h-[85dvh] sm:max-h-[90dvh] safe-bottom"
